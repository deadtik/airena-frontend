...
"use client"; // Required for the 'useEffect' hook for mouse tracking
...
// Note: Metadata is still useful for SEO but will be treated as static
// in a client component.
// export const metadata: Metadata = {
//   title: "Airena Frontend",
//   description: "Building Steadily",
// };
...
export default function RootLayout({
  ...
  useEffect(() => {
    // This effect adds the mouse-tracking gradient background
