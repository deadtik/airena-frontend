                ...
                <div className="container mx-auto">
                     <div className="max-w-3xl space-y-4">
                        ...
                        <div className="flex items-center gap-4 pt-4">
                            <button onClick={() => onNavigate('watch')} className="bg-emerald-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-emerald-600 transition-all transform hover:scale-105">Start Watching</button>
